...
#Add the bands in sncosmo registry
...
band_info = {
    ...
    #               Background  MWEBV
    # PanSTARRS
    'ps1::g':       (False,      True,       'C0',           'o'),
    'ps1::r':       (False,      True,       'C2',           '^'),
    'ps1::i':       (False,      True,       'C1',           'v',),
    'ps1::z':       (False,      True,       'C3',           '<'),

    # SDSS
    'sdss::u':       (False,      True,       'C4',           'v'),
    'sdss::g':       (False,      True,       'C0',           'o'),
    'sdss::r':       (False,      True,       'C2',           '^'),
    'sdss::i':       (False,      True,       'C1',           '>',),
    'sdss::z':       (False,      True,       'C3',           '<'),
    ...
    # CSP
    'cspu': (False, True, 'C0', 'o'),
    'cspg': (False, True, 'C1', 'v'),
    'cspr': (False, True, 'C2', '^'),
    'cspi': (False, True, 'C3', '<'),
    'cspz': (False, True, 'C4', '>'),
    'cspb': (False, True, 'C5', 's'),
    'cspk': (False, True, 'C6', 'S'),
    'cspv3009': (False, True, 'C7', 'p'),
    'cspv3014': (False, True, 'C8', 'P'),
    'cspv9844': (False, True, 'C9', '*'),

    #Testing
    # Spectral bands
    'band_0': (False, False, 'C0', 'o'),
    'band_1': (False, False, 'C0', 'o'),
    'band_2': (False, False, 'C0','^'),
    'band_3': (False, False, 'C0', 'v'),
    'band_4': (False, False, 'C0', '<'),
    'band_5': (False, False, 'C0', '>'),
    'band_6': (False, False, 'C0', 'p'),
    'band_7': (False, False, 'C0', 's'),
    'band_8': (False, False, 'C0', '*'),
    'band_9': (False, False, 'C0', 's'),
    'band_10': (False, False, 'C0', 's'),
    'band_11': (False, False, 'C3', 's'),
    'band_12': (False, False, 'C3', 's'),
    'band_13': (False, False, 'C3', 's'),
    'band_14': (False, False, 'C3', 's'),
    'band_15': (False, False, 'C3', 's'),
    'band_16': (False, False, 'C3', 's'),
    'band_17': (False, False, 'C3', 's'),
    'band_18': (False, False, 'C3', 's'),
    'band_19': (False, False, 'C3', 's'),
    'band_20': (False, False, 'C3', 's'),
    'band_21': (False, False, 'C3', 's'),
    'band_22': (False, False, 'C3', 's'),
    'band_23': (False, False, 'C3', 's'),
    'band_24': (False, False, 'C3', 's'),
    'band_25': (False, False, 'C3', 's'),
    'band_26': (False, False, 'C3', 's'),
    'band_27': (False, False, 'C3', 's'),
    'band_28': (False, False, 'C3', 's'),
    'band_29': (False, False, 'C3', 's'),
